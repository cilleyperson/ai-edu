...
- **Visual Progress Tracker:** Tracks and unlocks 9 distinct credentials (e.g. *Prompt Specialist*, *RAG Engineer*, *Vendor Auditor*, *NCUA Guardian*, *Risk Analyst*) stored in `localStorage` with automated window sync triggers.
...
### 3. Agent Sandbox Simulator (`/simulator`)
...
### 4. Prompt Engineering Lab (`/playground`)
...
### 5. Policy RAG Visualizer (`/rag-sandbox`)
...
### 6. AI Vendor Governance Auditor (`/vendor-auditor`)
...
### 7. Credit Union Risk Matrix (`/risk-matrix`)
